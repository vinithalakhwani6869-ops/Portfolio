...
const item = {
  ...
  show: { opacity: 1, x: 0, transition: { duration: 0.5, ease: [0.19, 1, 0.22, 1] } },
};
  ...
  return (
    ...
    >
      ...
      <motion.p variants={item} className="text-muted-foreground max-w-xl text-sm leading-relaxed mb-8">
        Translating complex logic into performant web interfaces.
        Currently building with Ruby on Rails & ERB, crafting clean
        server-rendered views with purpose.
      </motion.p>
